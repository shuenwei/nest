  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8] font-outfit relative">
      ...
      <div className="relative w-full min-h-[50vh] bg-gray-200 pb-16">
        ...
        <div className="relative z-10 px-6 pt-[calc(2.5rem+env(safe-area-inset-top))] [.telegram-webapp_&]:pt-[calc(2.5rem+var(--tg-safe-area-inset-top)+var(--tg-content-safe-area-inset-top))] text-white flex flex-col h-full w-full max-w-md mx-auto">
          <div className="flex items-start justify-between mb-8">
            ...
            <Avatar className="h-11 w-11 shadow-md" onClick={() => navigate("/settings")}>
              ...
              />
              <AvatarFallback className="bg-gray-200/80 text-black">
                {user.displayName
                  .split(" ")
                  .map((n) => n[0])
                  .join("")
      ...
      <div className="bg-[#F8F8F8] rounded-t-[2rem] min-h-[calc(50vh+2rem)] -mt-8 relative z-20 px-6 pt-8 pb-24">
